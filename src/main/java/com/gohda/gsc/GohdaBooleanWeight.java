 ...
 */
final class GohdaBooleanWeight extends Weight {
  /** The Similarity implementation. */
  final Similarity similarity;
  final GohdaBooleanQuery query;
  
  final ArrayList<Weight> weights;
  final boolean needsScores;

  GohdaBooleanWeight(GohdaBooleanQuery query, IndexSearcher searcher, boolean needsScores, float boost) throws IOException {
    super(query);
    this.query = query;
