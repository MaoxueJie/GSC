...
final class BooleanScorer extends BulkScorer {
  ...
  BooleanScorer(GohdaBooleanWeight weight, Collection<BulkScorer> scorers, int minShouldMatch, boolean needsScores) {
    ...
    for (BulkScorer scorer : scorers) {
      if (needsScores == false) {
        ...
        scorer = GohdaBooleanWeight.disableScoring(scorer);
      }
